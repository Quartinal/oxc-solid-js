                        ...
                        if correct != source {
                            diagnostics.push(
                                Diagnostic::warning(
                                    Self::NAME,
                                    spec.span,
                                    format!("Prefer importing {} from \"{}\".", name, correct),
                                )
                                .with_help(format!(
...
mod tests {
    ...
    fn test_correct_solid_js_import() {
        ...
        assert!(
            ...
            "correct imports should have no diagnostics"
        );
    }
    ...
    fn test_correct_web_imports() {
        ...
        assert!(
            diagnostics.is_empty(),
            "correct web imports should have no diagnostics"
        );
    }
    ...
    fn test_correct_store_imports() {
        ...
        assert!(
            diagnostics.is_empty(),
            "correct store imports should have no diagnostics"
        );
    }
    ...
    fn test_multiple_wrong_imports() {
        ...
        assert_eq!(
            diagnostics.len(),
            2,
            "should have two diagnostics (Portal and createStore)"
        );
    }
    ...
    fn test_type_import() {
        ...
        assert!(
            diagnostics.is_empty(),
            "correct type imports should have no diagnostics"
        );
    }
    ...
    fn test_inline_type_import() {
        ...
        assert!(
            diagnostics.is_empty(),
            "mixed imports should have no diagnostics"
        );
    }
    ...
    fn test_non_solid_import_ignored() {
        ...
        assert!(
            diagnostics.is_empty(),
            "non-solid imports should be ignored"
        );
    }
    ...
    fn test_components_from_solid_js() {
        ...
        assert!(
            diagnostics.is_empty(),
            "control flow components should be from solid-js"
        );
    }
}
