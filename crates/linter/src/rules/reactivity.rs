...
use oxc_ast::ast::{
    ...
    JSXExpressionContainer, JSXOpeningElement, VariableDeclarator,
};
...
const SIGNAL_CREATORS: &[&str] = &["createSignal", "createMemo", "createResource", "useContext"];
...
impl Reactivity {
    ...
    pub fn check_jsx_attribute<'a>(&self, opening: &JSXOpeningElement<'a>) -> Vec<Diagnostic> {
        let mut diagnostics = Vec::new();
