...
use common::{is_dynamic, TransformOptions, JSX_MEMBER_DASH_SENTINEL};

use crate::{
    ir::{helper_ident_expr, SSRChildTransformer, SSRContext, SSRResult},
    template,
};
...
pub fn transform_component<'a, 'b>(
    ...
    // Components in SSR are emitted as direct expressions.
